    ...
    <div class="card">
      <div class="card-header d-flex align-items-center">
        ...
        <div class="d-flex gap-2 ms-auto">
          <a href="<?= BASE_URL . 'guides' ?>" class="btn btn-secondary">
            <i class="bi bi-arrow-left me-1"></i> Quay lại
          </a>
          <a href="<?= BASE_URL . 'guide-edit?id=' . $guide['id'] ?>" class="btn btn-warning">
            ...
            <table class="table table-bordered mb-0">
              <tbody>
                ...
                <?php if (!empty($profile['created_at']) || !empty($profile['updated_at'])): ?>
                  ...
                  <?php if (!empty($profile['updated_at']) && $profile['updated_at'] !== $profile['created_at']): ?>
