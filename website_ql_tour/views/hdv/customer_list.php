...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">
            ...
            Tour khởi hành ngày:
            <?= isset($tour['start_date']) ? date('d/m/Y', strtotime($tour['start_date'])) : 'N/A' ?>
        </h3>
    </div>
                            ...
                            <td class="text-center">
                                <form method="POST" action="<?= BASE_URL ?>?act=hdv-checkin" style="display: inline-block;">
                                    ...
                                    <input type="hidden" name="status"
                                        value="<?= (isset($customer['checkin_status']) && $customer['checkin_status'] == 1) ? 0 : 1 ?>">
                                    ...
                                    <button type="submit"
                                        ...
                                        <i
                                            class="bi <?= (isset($customer['checkin_status']) && $customer['checkin_status'] == 1) ? 'bi-arrow-counterclockwise' : 'bi-check-circle' ?>"></i>
