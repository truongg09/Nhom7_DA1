...
class HomeController
{
    ...
    public function home(): void
    {
        ...
        // Hiển thị trang home chào mừng + thông tin tài khoản
        view('home', [
    ...
    // Trang dashboard thống kê - chỉ dành cho người đã đăng nhập (ADMIN)
    public function dashboard(): void
    {
        ...
        view('admin.dashboard', [
            'title' => 'Báo Cáo & Thống Kê - Website Quản Lý Tour',
            'user'  => $currentUser,
        ]);
    }
